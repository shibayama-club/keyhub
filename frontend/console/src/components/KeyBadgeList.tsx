...
export const KeyBadgeList = ({ keys }: KeyBadgeListProps) => {
  ...
  return (
    <div className="mt-2">
      <p className="mb-1 text-xs font-medium text-gray-500">鍵情報:</p>
      <div className="flex flex-wrap gap-2">
        {keys.map((key) => (
          <span key={key.id} className="inline-flex items-center space-x-1 rounded-md bg-gray-100 px-2 py-1 text-xs">
